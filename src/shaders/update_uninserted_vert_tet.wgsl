...
fn update_uninserted_vert_tet(
    ...
    // CRITICAL: vert_tet is position-indexed, use idx not vert_idx!
    let old_tet = vert_tet[idx];

    // Debug: record start state (idx, vert_idx, old_tet, num_uninserted)
